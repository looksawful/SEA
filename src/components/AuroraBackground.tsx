...
export const AuroraBackground = () => {
  ...
  useEffect(() => {
    ...
    if (intensityLocation) gl.uniform1f(intensityLocation, 0.9);
    if (color1Location) gl.uniform3f(color1Location, 0.2, 0.45, 1.0);
    if (color2Location) gl.uniform3f(color2Location, 0.02, 0.02, 0.03);
