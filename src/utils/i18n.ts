...
const UI: Record<Language, Record<string, UiValue>> = {
  ru: {
    ...
    correctSummary: ({ correct, total, accuracy }) =>
      `Правильно: ${correct} из ${total} (${accuracy}%)`,
    ...
    customQuestionsModalDescription: "Выбери игру и добавь вопросы в одном стиле с базовыми заданиями.",
    close: "Закрыть",
    enableCustom: "Включить свои вопросы",
    customEnabled: "Свои вопросы включены",
    addAtLeastOne: "Добавь хотя бы один вопрос",
    ...
    customQuestionsDescription: "Создай вопросы, подсказки и объяснения для режима игры.",
    customQuestionsEmptyTitle: "Свои вопросы не найдены",
    customQuestionsEmptyHint: "Добавь вопросы в редакторе, чтобы играть в своём режиме.",
  ...
  en: {
    ...
    correctSummary: ({ correct, total, accuracy }) =>
      `Correct: ${correct} of ${total} (${accuracy}%)`,
...
const GAME_LABELS_EN: Record<GameId, { name: string; description: string }> = {
  ...
  "color-eye": {
    name: "Color Eye",
    description: "Pick the tone from a photo",
  },
  "color-wheel": {
    name: "Color Wheel",
  ...
  "film-type": {
    name: "Film Type",
    description: "Recognize film look",
  },
  "composition-technique": {
    name: "Composition",
    description: "Identify the composition technique",
  },
  "focal-length": {
    name: "Focal Length",
    description: "Guess focal length from photo",
  },
  "wcag-issue": {
    name: "WCAG Issue",
