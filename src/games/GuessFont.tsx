...
const FONTS: FontInfo[] = [
  ...
  },
  {
    ...
    characteristics: text(
      "Контрастная антиква в стиле переходного периода",
      "High-contrast serif in the transitional style",
    ),
  },
  {
    name: "Merriweather",
  ...
  const handleSelect = useCallback(
    (index: number) => {
      ...
      if (correct) {
        ...
        const explanation =
          language === "ru"
            ? `${challenge.font.name} — ${correctDescription}. ${userAnswer.name} — ${userDescription}. Обратите внимание на форму букв "a", "g", "e" и характер засечек.`
    ...
    <div className="space-y-6">
      <div className="text-center space-y-2">
        ...
        <HintToggle
          hint={
            language === "ru"
              ? 'Смотрите на формы "a", "g", контраст штрихов и наличие засечек.'
