    ...
    <div className="space-y-6">
      <div className="text-center space-y-2">
        <h2 className="text-xl sm:text-2xl font-display font-semibold tracking-tight">
          {language === "ru" ? "Угадать HSL-параметры" : "Guess the HSL parameters"}
        </h2>
        <HintToggle
          hint={
            language === "ru"
        ...
        {challenge.options.map((hsl, index) => (
          ...
          >
            <div className="text-center font-mono text-sm space-y-1">
              <div>
                H: <span className="font-bold">{hsl.h}°</span>
              </div>
              <div>
                S: <span className="font-bold">{hsl.s}%</span>
              </div>
              <div>
                L: <span className="font-bold">{hsl.l}%</span>
              </div>
